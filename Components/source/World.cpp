...
World::World()
{
	...
	walls.push_back(Wall(Vector4(-1, 0, 0), Vector4(0, 1, 0), Vector4(-20, 0, 0)));
	walls.push_back(Wall(Vector4(0, 1, 0), Vector4(1, 0, 0), Vector4(0, 80, 0)));
	walls.push_back(Wall(Vector4(0, -1, 0), Vector4(1, 0, 0), Vector4(0, -5, 0)));
    walls.push_back(Wall(Vector4(0, 0, 1), Vector4(0, 1, 0), Vector4(0, 0, 0)));
    walls.push_back(Wall(Vector4(0, 0, -1), Vector4(0, 1, 0), Vector4(0, 0, -10)));
}
